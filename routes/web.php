...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth', \App\Http\Middleware\Admin::class])->group(function () {
        ...
        Route::prefix('orders')->group(function () {
            ...
            Route::put('/{order}/status', [OrdersController::class, 'updateStatus'])->name('admin.orders.status.update');
        ...
        Route::prefix('stock')->group(function () {
            ...
            Route::post('/process-in', [StockController::class, 'processStockIn'])->name('admin.stock.process-in');
            ...
            Route::post('/process-out', [StockController::class, 'processOut'])->name('admin.stock.process-out');
        });
...
Route::prefix('customer')->name('customer.')->group(function () {
    ...
    // Orders routes
    Route::get('/orders', [CustomerOrdersController::class, 'index'])->name('orders')->middleware('auth');
    ...
    Route::prefix('cart')->name('cart.')->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            Route::delete('/remove/{rowId}', [CustomerCartController::class, 'remove'])->name('remove');
        });
    });
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('account')->name('account.')->group(function () {
        ...
        Route::get('/password', function () {
            return view('Customer.views.account.password');
        })->name('password');
        ...
        Route::prefix('addresses')->name('addresses.')->group(function () {
            ...
            Route::post('/{address}/make-default', [AddressController::class, 'makeDefault'])->name('make-default');
        });

        // Reviews Route
        Route::get('/reviews', function () {
            return view('Customer.views.account.reviews');
        })->name('reviews');
    });
    ...
    Route::prefix('checkout')->name('customer.checkout.')->group(function () {
        ...
        Route::post('/shipping', [CheckoutController::class, 'saveShipping'])->name('shipping.save');
        Route::get('/payment', [CheckoutController::class, 'showPayment'])->name('payment');
        Route::post('/payment', [CheckoutController::class, 'savePayment'])->name('payment.save');
...
Route::get('/support', function () {
    return view('Customer.views.support.index');
})->name('support');

Route::get('/faq', function () {
    return view('Customer.views.support.faq');
})->name('faq');

// Promotions Route
Route::get('/promotions', function () {
    return view('Customer.views.promotions.index');
})->name('promotions');
...
Route::get('/review-stats', function() {
    ...
    return [
        ...
        'sample_reviews' => DB::table('product_reviews')
...
Route::get('storage/app/products/{path}', function ($path) {
