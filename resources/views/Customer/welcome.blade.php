...
<head>
    ...
    <link rel="preload" href="{{ asset('css/tailwind-custom.css') }}" as="style"/>
    ...
    <script src="https://cdn.tailwindcss.com/3.4.5?plugins=forms@0.5.7,typography@0.5.13,aspect-ratio@0.4.2,container-queries@0.1.1" defer></script>
    <script src="{{ asset('js/tailwind-config.min.js') }}" data-color="#000000" data-border-radius="small" defer></script>
...
<body class="bg-gray-50">
    ...
    <main class="mt-16 loading" id="mainContent">
        <section class="relative bg-gray-900 h-[650px] overflow-hidden">
            <div class="absolute inset-0">
                <img src="{{ asset('images/Customerpanel/background.webp') }}" 
                ...
                <div class="group relative bg-white rounded-2xl p-4 card-hover border border-gray-100">
                    <a href="{{ route('customer.products.show', $product->id) }}" class="block">
                        <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-xl bg-gray-200 lg:aspect-none group-hover:opacity-90 lg:h-80">
                            <img src="{{ url('storage/app/products/' . $product->main_image) }}" alt="{{ $product->name }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const addLoadingSpinner = (img) => {
                ...
                spinner.innerHTML = '<svg class="animate-spin h-8 w-8 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';
