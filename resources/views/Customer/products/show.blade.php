                        ...
                        <div class="lg:w-1/2">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                ...
                                <div class="bg-white rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-600 transition duration-150 border border-gray-200"
                                     onclick="updateMainImage('{{ url('storage/app/products/' . $product->main_image) }}')">
                                    <img src="{{ url('storage/app/products/' . $product->main_image) }}"
                                ...
                                @if($product->image_1)
                                <div class="bg-white rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-600 transition duration-150 border border-gray-200"
                                     onclick="updateMainImage('{{ url('storage/app/products/' . $product->image_1) }}')">
                                    <img src="{{ url('storage/app/products/' . $product->image_1) }}"
                                ...
                                @if($product->image_2)
                                <div class="bg-white rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-600 transition duration-150 border border-gray-200"
                                     onclick="updateMainImage('{{ url('storage/app/products/' . $product->image_2) }}')">
                                    <img src="{{ url('storage/app/products/' . $product->image_2) }}"
                                ...
                                @if($product->image_3)
                                <div class="bg-white rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-600 transition duration-150 border border-gray-200"
                                     onclick="updateMainImage('{{ url('storage/app/products/' . $product->image_3) }}')">
                                    <img src="{{ url('storage/app/products/' . $product->image_3) }}"
                                ...
                                @if($product->image_4)
                                <div class="bg-white rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-600 transition duration-150 border border-gray-200"
                                     onclick="updateMainImage('{{ url('storage/app/products/' . $product->image_4) }}')">
                                    <img src="{{ url('storage/app/products/' . $product->image_4) }}"
