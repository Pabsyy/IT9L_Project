    ...
    <div class="bg-transparent min-h-screen flex items-center justify-center p-4">
        <div class="relative w-full max-w-4xl flex rounded-xl overflow-hidden shadow-2xl">
            ...
            <div class="w-full md:w-3/5 bg-white p-8 flex flex-col justify-center relative">
                ...
                @if ($errors->has('terms'))
                    <div id="terms-error" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                        <span class="block sm:inline">Please accept the Terms of Service and Security Policy to continue.</span>
                    </div>
                @endif
                    ...
                    <form method="POST" action="{{ route('admin.register.submit') }}" class="space-y-5">
                        ...
                        <div class="text-center mt-4">
                            <p class="text-gray-600 text-sm">
                                ...
                                <a href="{{ route('admin.login') }}" class="text-primary font-medium hover:text-primary/80">Sign In</a>
                            </p>
                        </div>
                    </form>
                </div>
