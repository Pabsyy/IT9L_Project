    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-auto p-6">
            ...
            <div class="flex items-center mb-6">
                ...
                <span class="text-gray-800">Stock In</span>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Add Stock</h2>
                    <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-500">
                        <i class="ri-arrow-up-circle-line text-xl"></i>
                    </div>
                </div>
                
                <form action="{{ route('admin.stock.process-in') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="reference_number" class="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-primary/30 focus:border-primary" placeholder="SI-2024-001">
                        </div>

                        <!-- Source -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Source</label>
                            <select name="source" class="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-primary/30 focus:border-primary" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="number" name="unit_cost" step="0.01" min="0" class="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-primary/30 focus:border-primary" required>
                                <div class="ml-2 text-gray-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="1" class="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-primary/30 focus:border-primary" placeholder="Optional notes about this stock addition"></textarea>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Recent Stock Additions</h2>
                        ...
                        <div class="border border-gray-100 rounded-lg p-4">
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span class="text-green-600 flex items-center">
                                    <i class="ri-arrow-up-circle-fill mr-1"></i>
                                    {{ $movement->quantity }}
                                </span>
                            </div>
