...
class StockController extends Controller
{
    public function stockIn()
    {
        ...
        $recentMovements = InventoryMovement::whereIn('type', ['purchase', 'return', 'adjustment'])
            ->where('quantity', '>', 0) // Ensure we only get stock in movements
            ->with(['product', 'user'])
    ...
    public function processStockIn(Request $request)
    {
        $request->validate([
            ...
            'source' => 'required|string|in:purchase,return,adjustment,other',
